...
<script type="text/javascript">
  ...
  <body>
<form id="form1" action="<c:url value='/saveOrder'/>" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
	...
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='/getBookByBid?bid=${o.book.bid}'/>"><img border="0" width="54" align="top" src="<c:url value='/${o.book.image_b }'/>"/></a>
		</td>
		<td align="left">
			<a href="<c:url value='/getBookByBid?bid=${o.book.bid}'/>"><span>${o.book.bname }</span></a>
		</td>
		<td>&yen;${o.book.currPrice }</td>
		<td>${o.quantity}</td>
		<td>
			<span class="price_n">&yen;<span class="subtotal">${o.subtotal}</span></span>
		</td>
	</tr>
	</c:forEach>
