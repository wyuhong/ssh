		...
		<table align="center" border="0" width="100%" cellpadding="0"
			...
			<tr class="tt">
				<td width="320px">订单号：<a
					href="<c:url value='/getOrderByOid?order.oid=${o.oid }'/>">${o.oid }</a></td>
			...
			<tr style="padding-top: 10px; padding-bottom: 10px;">
				...
				<c:forEach items="${o.orderItemList}" var="oi">
					<a class="link2" href="<c:url value='/getBookByBid?book.bid=${oi.bid }'/>"> 
						<img border="0" width="70" src="<c:url value='/${oi.image_b }'/>" />
					</a>
				</c:forEach>
				</td>
				...
				<td><a href="<c:url value='/getOrderByOid?order.oid=${o.oid }'/>">查看</a><br />

					<a href="<c:url value='/toPayOrder?order.oid=${o.oid }'/>">支付</a><br /> <a
					href="<c:url value='/getOrderByOid?action=cancel&order.oid=${o.oid }'/>">取消</a><br /> <a
					href="<c:url value='/getOrderByOid?action=confirm&order.oid=${o.oid }'/>">确认收货</a><br /></td>
			</tr>
			</c:forEach>
