...
<html>
  ...
  <body>
	...
	<div class="div1">
		<form action="/ssh_goods/updatepass" method="post" target="_top" id="updatepassform">
		...
		<table>
			...
			<tr>
				<td align="right"></td>
				<td>
				  <img id="vCode" src="<c:url value='/vcode'/>" border="1"/>
		    	  <a id="repImg" href="javascript:_change();">看不清，换一张</a>
				</td>
			</tr>
			<tr>
	...
	<script type="text/javascript" src="<c:url value='/jsps/js/user/mypwd.js'/>"></script>
  </body>
</html>
