...
<html>
  <head>
	...
	<style type="text/css">
		/* .successClass{color:green;border:1px green solid;background:url(/goods/images/yes.png) no—repeat;background-color:#f7fef2 } */
	.successClass{line-height: 32px; font-size: 10pt; color: green; border: 1px green solid; padding: 8px 8px 8px 35px; background: url(/ssh_goods/images/yes.png) no-repeat; background-color: #f7fef2;}
	</style>
...
<div class="divBody">
  ...
  <div class="divCenter">
    <form id="regform" action="/ssh_goods/regist" method="post">
    ...
    <table>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>
          <span class="verifyCodeImg"><img id="vCode" width="100" src="<c:url value='/vcode'/>" /></span>
        </td>
      ...
      <tr>
        ...
        <td>
     	 <!--   立即注册按钮 -->
          <input type="image" src="<c:url value='/images/regist1.jpg'/>" id="btnSubmit"/>
        </td>
        <td>&nbsp;</td>
      </tr>
    </table>
